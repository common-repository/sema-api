...
/*!
SEMA WP plugin backend
by S+Even 
Version 1.3
Copyright (c) 2011-2018 SEMA SDC http://semadata.org
...
jQuery(document).ready(function($) {
    ...
    var sema_username = $("#sema_username");
    var sema_password = $("#password");
    var sema_token = $("#sema_token");
	
    //create token
    jQuery( document ).on( 'click', '#token', function(e) { 
	     e.preventDefault();
         var user = $("#sema_username" ).val();  
         var pass = $("#sema_password" ).val();  
         ...
         jQuery.ajax({
            ...
            success : function( data ) {
               ...
               if(token != undefined && token.length != 0){
				  $(sema_token).val(token); 
				  $("#sema_user").val(user);
                  $("#passwordwrong-msg-div").hide();  
               }else{
                  $("#passwordwrong-msg-div").show();  
              }
            }
        });
    });
...
// fitment section in product edit page
